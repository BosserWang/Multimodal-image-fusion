...
def val_fusion_detection(model):
    vi_root = './images/Visible/'
    ir_root = './images/Infrared/'
...
def main():
    ...
    model.load_state_dict(torch.load("./checkpoint/model_meta0_72.pth"),strict=False)
    print('| Model Load Done!')
    return val_fusion_detection(model)
